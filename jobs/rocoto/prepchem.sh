...
#cd $tiledir
    ...
    eval $NLN $EMIINPUT/fengsha/12month/dust12m_data.tile${n}.nc .
    eval $NLN $EMIINPUT/EMI/12month/emi12m_data.tile${n}.nc .
 ## eval $NLN $EMIINPUT/GBBEPx/${SYEAR}${SMONTH}01/FIRE2_GBBEPx_data.tile${n}.nc .
    eval $NLN /scratch2/BMC/gsd-fv3-dev/FV3-MOM6-CICE5/GBBEPx.in.FV3${CASE}Grid/${SYEAR}${SMONTH}01/FIRE2_GBBEPx_data.tile${n}.nc .
    ...
    if [ $EMITYPE -eq 2 ]; then
     ...
     DIRGB=/scratch2/BMC/gsd-fv3-dev/FV3-MOM6-CICE5/GBBEPx.in.FV3C${res}Grid/
     fi
   #NCGB=/scratch1/BMC/gsd-fv3-dev/Haiqin.Li/Develop/emi_${CASE}/GBBEPx
    NCGB=/scratch2/BMC/gsd-fv3-dev/FV3-MOM6-CICE5/GBBEPx.in.FV3C${res}Grid/
...
elif [ ${SYEAR} -eq 2019 ];  then
  BC=${emiss_date1}.GBBEPx.bc.FV3.${CASE}Grid.tile${n}.bin
  OC=${emiss_date1}.GBBEPx.oc.FV3.${CASE}Grid.tile${n}.bin
  PM25=${emiss_date1}.GBBEPx.pm25.FV3.${CASE}Grid.tile${n}.bin
  SO2=${emiss_date1}.GBBEPx.so2.FV3.${CASE}Grid.tile${n}.bin
  FRP=${emiss_date1}.meanFRP.FV3.${CASE}Grid.tile${n}.bin
else
